...
export interface ProductModelsReadProduct {
    ...
    active?: boolean;
    /**
     * The purchase price in the currency defined in {Carismar.MgmtAPI.Features.Product.Models.Read.Product.PurchasePriceCurrency}.
     * @type {number}
     * @memberof ProductModelsReadProduct
     */
    purchasePrice?: number;
    /**
     * The 3-letter ISO 4217 currency code for the amount given in {Carismar.MgmtAPI.Features.Product.Models.Read.Product.PurchasePrice}.
     * @type {string}
     * @memberof ProductModelsReadProduct
     */
