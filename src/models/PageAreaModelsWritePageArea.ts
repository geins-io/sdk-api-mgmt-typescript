...
import type { SystemNullableValidationConfiguration } from './SystemNullableValidationConfiguration';
import {
    SystemNullableValidationConfigurationFromJSON,
    SystemNullableValidationConfigurationFromJSONTyped,
    SystemNullableValidationConfigurationToJSON,
} from './SystemNullableValidationConfiguration';

/**
 * The API-version of the PageArea class
 * @export
 * @interface PageAreaModelsWritePageArea
 */
export interface PageAreaModelsWritePageArea {
    /**
     * The primary id of this page are family collection
     * @type {number}
     * @memberof PageAreaModelsWritePageArea
     */
    index?: number;
    /**
    ...
    /**
     * 
     * @type {SystemNullableValidationConfiguration}
     * @memberof PageAreaModelsWritePageArea
     */
...
/**
 * Check if a given object implements the PageAreaModelsWritePageArea interface.
 */
export function instanceOfPageAreaModelsWritePageArea(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PageAreaModelsWritePageAreaFromJSON(json: any): PageAreaModelsWritePageArea {
    return PageAreaModelsWritePageAreaFromJSONTyped(json, false);
}

export function PageAreaModelsWritePageAreaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageAreaModelsWritePageArea {
    ...
    return {
        ...
        'settings': !exists(json, 'Settings') ? undefined : SystemNullableValidationConfigurationFromJSON(json['Settings']),
    };
}

export function PageAreaModelsWritePageAreaToJSON(value?: PageAreaModelsWritePageArea | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'Settings': SystemNullableValidationConfigurationToJSON(value.settings),
    };
}
