 ...
 * @export
 * @interface PriceListModelsWritePriceListPrice
 */
export interface PriceListModelsWritePriceListPrice {
    /**
     * The price list id.  
     * Prices on Campaign price lists can not be updated. Any such entries will be ignored.
     * @type {number}
     * @memberof PriceListModelsWritePriceListPrice
     */
    priceListId?: number;
    /**
...
/**
 * Check if a given object implements the PriceListModelsWritePriceListPrice interface.
 */
export function instanceOfPriceListModelsWritePriceListPrice(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PriceListModelsWritePriceListPriceFromJSON(json: any): PriceListModelsWritePriceListPrice {
    return PriceListModelsWritePriceListPriceFromJSONTyped(json, false);
}

export function PriceListModelsWritePriceListPriceFromJSONTyped(json: any, ignoreDiscriminator: boolean): PriceListModelsWritePriceListPrice {
...
export function PriceListModelsWritePriceListPriceToJSON(value?: PriceListModelsWritePriceListPrice | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
