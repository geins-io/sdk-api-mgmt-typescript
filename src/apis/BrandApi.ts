...
export class BrandApi extends runtime.BaseAPI {
     ...
     * Get brand
     */
    async getBrandRaw(requestParameters: GetBrandRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EnvelopeBrandModelsReadBrand>> {
     ...
     * Get brand
     */
    async getBrand(requestParameters: GetBrandRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EnvelopeBrandModelsReadBrand> {
