 ...
 * 
 * @export
 * @interface OrderProcessedRefund
 */
export interface OrderProcessedRefund {
    /**
     * 
     * @type {string}
     * @memberof OrderProcessedRefund
     */
    refundId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the OrderProcessedRefund interface.
 */
export function instanceOfOrderProcessedRefund(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OrderProcessedRefundFromJSON(json: any): OrderProcessedRefund {
    return OrderProcessedRefundFromJSONTyped(json, false);
}

export function OrderProcessedRefundFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderProcessedRefund {
...
export function OrderProcessedRefundToJSON(value?: OrderProcessedRefund | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
