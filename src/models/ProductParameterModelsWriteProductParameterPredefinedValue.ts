 ...
 * @export
 * @interface ProductParameterModelsWriteProductParameterPredefinedValue
 */
export interface ProductParameterModelsWriteProductParameterPredefinedValue {
    /**
     * The unique identifier for the parameter.
     * @type {number}
     * @memberof ProductParameterModelsWriteProductParameterPredefinedValue
     */
    parameterId?: number;
    /**
...
/**
 * Check if a given object implements the ProductParameterModelsWriteProductParameterPredefinedValue interface.
 */
export function instanceOfProductParameterModelsWriteProductParameterPredefinedValue(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProductParameterModelsWriteProductParameterPredefinedValueFromJSON(json: any): ProductParameterModelsWriteProductParameterPredefinedValue {
    return ProductParameterModelsWriteProductParameterPredefinedValueFromJSONTyped(json, false);
}

export function ProductParameterModelsWriteProductParameterPredefinedValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductParameterModelsWriteProductParameterPredefinedValue {
    ...
    return {
        ...
        'predefinedValueId': !exists(json, 'PredefinedValueId') ? undefined : json['PredefinedValueId'],
...
export function ProductParameterModelsWriteProductParameterPredefinedValueToJSON(value?: ProductParameterModelsWriteProductParameterPredefinedValue | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'PredefinedValueId': value.predefinedValueId,
        'Name': value.name,
