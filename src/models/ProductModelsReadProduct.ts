...
import type { ProductModelsReadDiscountCampaign } from './ProductModelsReadDiscountCampaign';
import {
    ProductModelsReadDiscountCampaignFromJSON,
    ProductModelsReadDiscountCampaignFromJSONTyped,
    ProductModelsReadDiscountCampaignToJSON,
} from './ProductModelsReadDiscountCampaign';
...
export interface ProductModelsReadProduct {
    ...
    /**
     * The <a href="https://en.wikipedia.org/wiki/ISO_4217">3-letter ISO 4217 currency code</a> for the amount given in PurchasePrice.
     * @type {string}
     * @memberof ProductModelsReadProduct
     */
     ...
     * @type {Array<ProductModelsReadDiscountCampaign>}
     * @memberof ProductModelsReadProduct
     */
    discountCampaigns?: Array<ProductModelsReadDiscountCampaign>;
}
...
export function ProductModelsReadProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductModelsReadProduct {
    ...
    return {
        ...
        'dateFirstAvailable': !exists(json, 'DateFirstAvailable') ? undefined : (new Date(json['DateFirstAvailable'])),
        ...
        'discountCampaigns': !exists(json, 'DiscountCampaigns') ? undefined : ((json['DiscountCampaigns'] as Array<any>).map(ProductModelsReadDiscountCampaignFromJSON)),
    };
}
...
export function ProductModelsReadProductToJSON(value?: ProductModelsReadProduct | null): any {
    ...
    return {
        ...
        'DateFirstAvailable': value.dateFirstAvailable === undefined ? undefined : (value.dateFirstAvailable.toISOString()),
        'Active': value.active,
        ...
        'DiscountCampaigns': value.discountCampaigns === undefined ? undefined : ((value.discountCampaigns as Array<any>).map(ProductModelsReadDiscountCampaignToJSON)),
    };
}
