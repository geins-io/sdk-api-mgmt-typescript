 ...
 * 
 * @export
 * @interface WebhookModelsRestWebhook
 */
export interface WebhookModelsRestWebhook {
    /**
     * Type of entity.  
     * 0 = NOT_SET  
     * 1 = Brand  
     ...
     * 9 = Supplier
     * @type {number}
     * @memberof WebhookModelsRestWebhook
     */
    entity?: WebhookModelsRestWebhookEntityEnum;
    /**
     * Webhook Name
     * @type {string}
     * @memberof WebhookModelsRestWebhook
 ...
 * @export
 */
export const WebhookModelsRestWebhookEntityEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2,
    NUMBER_3: 3,
...
export type WebhookModelsRestWebhookEntityEnum = typeof WebhookModelsRestWebhookEntityEnum[keyof typeof WebhookModelsRestWebhookEntityEnum];


/**
 * Check if a given object implements the WebhookModelsRestWebhook interface.
 */
export function instanceOfWebhookModelsRestWebhook(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WebhookModelsRestWebhookFromJSON(json: any): WebhookModelsRestWebhook {
    return WebhookModelsRestWebhookFromJSONTyped(json, false);
}

export function WebhookModelsRestWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookModelsRestWebhook {
...
export function WebhookModelsRestWebhookToJSON(value?: WebhookModelsRestWebhook | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
