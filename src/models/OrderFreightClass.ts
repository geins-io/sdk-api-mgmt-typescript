 ...
 * 
 * @export
 * @interface OrderFreightClass
 */
export interface OrderFreightClass {
    /**
     * 
     * @type {number}
     * @memberof OrderFreightClass
     */
    id?: number;
    /**
     * 
     ...
     * @memberof OrderFreightClass
     */
    readonly typeAsEnum?: OrderFreightClassTypeAsEnumEnum;
}
 ...
 * @export
 */
export const OrderFreightClassTypeAsEnumEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2
} as const;
export type OrderFreightClassTypeAsEnumEnum = typeof OrderFreightClassTypeAsEnumEnum[keyof typeof OrderFreightClassTypeAsEnumEnum];


/**
 * Check if a given object implements the OrderFreightClass interface.
 */
export function instanceOfOrderFreightClass(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OrderFreightClassFromJSON(json: any): OrderFreightClass {
    return OrderFreightClassFromJSONTyped(json, false);
}

export function OrderFreightClassFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderFreightClass {
    ...
    return {
        ...
        'typeAsEnum': !exists(json, 'TypeAsEnum') ? undefined : json['TypeAsEnum'],
    };
}

export function OrderFreightClassToJSON(value?: OrderFreightClass | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
