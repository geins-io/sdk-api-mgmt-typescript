...
export function OrderModelsOrderRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderModelsOrderRow {
    ...
    return {
        ...
        'productPackageId': !exists(json, 'ProductPackageId') ? undefined : json['ProductPackageId'],
        'productPackageName': !exists(json, 'ProductPackageName') ? undefined : json['ProductPackageName'],
        'productPackageGroupId': !exists(json, 'ProductPackageGroupId') ? undefined : json['ProductPackageGroupId'],
    };
}
...
export function OrderModelsOrderRowToJSON(value?: OrderModelsOrderRow | null): any {
    ...
    return {
        ...
        'ProductPackageId': value.productPackageId,
        'ProductPackageName': value.productPackageName,
        'ProductPackageGroupId': value.productPackageGroupId,
    };
}
