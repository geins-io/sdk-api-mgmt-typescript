...
export class CategoryApi extends runtime.BaseAPI {
     ...
     * Get category
     */
    async getCategoryRaw(requestParameters: GetCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EnvelopeCategoryModelsReadCategory>> {
     ...
     * Get category
     */
    async getCategory(requestParameters: GetCategoryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EnvelopeCategoryModelsReadCategory> {
