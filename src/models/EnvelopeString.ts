 ...
 * @export
 * @interface EnvelopeString
 */
export interface EnvelopeString {
    /**
     * A status message for the action taken.
     * @type {string}
     * @memberof EnvelopeString
     */
    message?: string;
    /**
...
/**
 * Check if a given object implements the EnvelopeString interface.
 */
export function instanceOfEnvelopeString(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EnvelopeStringFromJSON(json: any): EnvelopeString {
    return EnvelopeStringFromJSONTyped(json, false);
}

export function EnvelopeStringFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvelopeString {
...
export function EnvelopeStringToJSON(value?: EnvelopeString | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
