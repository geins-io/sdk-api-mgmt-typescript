 ...
 * @export
 * @interface EnvelopeCategoryModelsReadCategory
 */
export interface EnvelopeCategoryModelsReadCategory {
    /**
     * A status message for the action taken.
     * @type {string}
     * @memberof EnvelopeCategoryModelsReadCategory
     */
    message?: string;
    /**
    ...
    /**
     * 
     * @type {CategoryModelsReadCategory}
     * @memberof EnvelopeCategoryModelsReadCategory
     */
    resource?: CategoryModelsReadCategory;
    /**
     * 
     * @type {PageResult}
     * @memberof EnvelopeCategoryModelsReadCategory
...
/**
 * Check if a given object implements the EnvelopeCategoryModelsReadCategory interface.
 */
export function instanceOfEnvelopeCategoryModelsReadCategory(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EnvelopeCategoryModelsReadCategoryFromJSON(json: any): EnvelopeCategoryModelsReadCategory {
    return EnvelopeCategoryModelsReadCategoryFromJSONTyped(json, false);
}

export function EnvelopeCategoryModelsReadCategoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvelopeCategoryModelsReadCategory {
    ...
    return {
        ...
        'resource': !exists(json, 'Resource') ? undefined : CategoryModelsReadCategoryFromJSON(json['Resource']),
        'pageResult': !exists(json, 'PageResult') ? undefined : PageResultFromJSON(json['PageResult']),
    };
}

export function EnvelopeCategoryModelsReadCategoryToJSON(value?: EnvelopeCategoryModelsReadCategory | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'Resource': CategoryModelsReadCategoryToJSON(value.resource),
