 ...
 * 
 * @export
 * @interface ShippingModelsShippingSubOption
 */
export interface ShippingModelsShippingSubOption {
    /**
     * 
     * @type {number}
     * @memberof ShippingModelsShippingSubOption
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ShippingModelsShippingSubOption interface.
 */
export function instanceOfShippingModelsShippingSubOption(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ShippingModelsShippingSubOptionFromJSON(json: any): ShippingModelsShippingSubOption {
    return ShippingModelsShippingSubOptionFromJSONTyped(json, false);
}

export function ShippingModelsShippingSubOptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShippingModelsShippingSubOption {
...
export function ShippingModelsShippingSubOptionToJSON(value?: ShippingModelsShippingSubOption | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
