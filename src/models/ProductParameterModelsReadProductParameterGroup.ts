 ...
 * @export
 * @interface ProductParameterModelsReadProductParameterGroup
 */
export interface ProductParameterModelsReadProductParameterGroup {
    /**
     * The unique identifier for the groups.
     * @type {number}
     * @memberof ProductParameterModelsReadProductParameterGroup
     */
    groupId?: number;
    /**
...
/**
 * Check if a given object implements the ProductParameterModelsReadProductParameterGroup interface.
 */
export function instanceOfProductParameterModelsReadProductParameterGroup(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProductParameterModelsReadProductParameterGroupFromJSON(json: any): ProductParameterModelsReadProductParameterGroup {
    return ProductParameterModelsReadProductParameterGroupFromJSONTyped(json, false);
}

export function ProductParameterModelsReadProductParameterGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductParameterModelsReadProductParameterGroup {
...
export function ProductParameterModelsReadProductParameterGroupToJSON(value?: ProductParameterModelsReadProductParameterGroup | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
