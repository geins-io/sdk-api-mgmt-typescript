 ...
 * A related product.
 * @export
 * @interface ProductModelsReadRelatedProduct
 */
export interface ProductModelsReadRelatedProduct {
    /**
     * The unique identifier for the product.
     * @type {number}
     * @memberof ProductModelsReadRelatedProduct
     */
    productId?: number;
    /**
...
/**
 * Check if a given object implements the ProductModelsReadRelatedProduct interface.
 */
export function instanceOfProductModelsReadRelatedProduct(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProductModelsReadRelatedProductFromJSON(json: any): ProductModelsReadRelatedProduct {
    return ProductModelsReadRelatedProductFromJSONTyped(json, false);
}

export function ProductModelsReadRelatedProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductModelsReadRelatedProduct {
...
export function ProductModelsReadRelatedProductToJSON(value?: ProductModelsReadRelatedProduct | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
