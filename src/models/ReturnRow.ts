...
export interface ReturnRow {
    ...
    returnCode?: number;
    /**
     * The action taken for this return row.
     ...
     * @memberof ReturnRow
     */
    returnAction?: ReturnRowReturnActionEnum;
}
 ...
 * @export
 */
export const ReturnRowReturnActionEnum = {
    NUMBER_1: 1,
    NUMBER_2: 2,
    NUMBER_3: 3,
    NUMBER_4: 4
} as const;
export type ReturnRowReturnActionEnum = typeof ReturnRowReturnActionEnum[keyof typeof ReturnRowReturnActionEnum];


/**
 * Check if a given object implements the ReturnRow interface.
 */
export function instanceOfReturnRow(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReturnRowFromJSON(json: any): ReturnRow {
    return ReturnRowFromJSONTyped(json, false);
}

export function ReturnRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReturnRow {
    ...
    return {
        ...
        'returnRowId': !exists(json, 'ReturnRowId') ? undefined : json['ReturnRowId'],
...
export function ReturnRowToJSON(value?: ReturnRow | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
