 ...
 * @export
 * @interface VariantModelsWriteVariant
 */
export interface VariantModelsWriteVariant {
    /**
     * The name of the variant, eg "Color", "Weight" etc.
     * @type {string}
     * @memberof VariantModelsWriteVariant
     */
    label?: string;
    /**
...
/**
 * Check if a given object implements the VariantModelsWriteVariant interface.
 */
export function instanceOfVariantModelsWriteVariant(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VariantModelsWriteVariantFromJSON(json: any): VariantModelsWriteVariant {
    return VariantModelsWriteVariantFromJSONTyped(json, false);
}

export function VariantModelsWriteVariantFromJSONTyped(json: any, ignoreDiscriminator: boolean): VariantModelsWriteVariant {
...
export function VariantModelsWriteVariantToJSON(value?: VariantModelsWriteVariant | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
