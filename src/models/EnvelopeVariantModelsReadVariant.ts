 ...
 * @export
 * @interface EnvelopeVariantModelsReadVariant
 */
export interface EnvelopeVariantModelsReadVariant {
    /**
     * A status message for the action taken.
     * @type {string}
     * @memberof EnvelopeVariantModelsReadVariant
     */
    message?: string;
    /**
...
/**
 * Check if a given object implements the EnvelopeVariantModelsReadVariant interface.
 */
export function instanceOfEnvelopeVariantModelsReadVariant(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EnvelopeVariantModelsReadVariantFromJSON(json: any): EnvelopeVariantModelsReadVariant {
    return EnvelopeVariantModelsReadVariantFromJSONTyped(json, false);
}

export function EnvelopeVariantModelsReadVariantFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvelopeVariantModelsReadVariant {
...
export function EnvelopeVariantModelsReadVariantToJSON(value?: EnvelopeVariantModelsReadVariant | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
