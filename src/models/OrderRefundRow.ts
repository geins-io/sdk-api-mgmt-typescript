...
/**
 * Check if a given object implements the OrderRefundRow interface.
 */
export function instanceOfOrderRefundRow(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OrderRefundRowFromJSON(json: any): OrderRefundRow {
    return OrderRefundRowFromJSONTyped(json, false);
}

export function OrderRefundRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderRefundRow {
...
export function OrderRefundRowToJSON(value?: OrderRefundRow | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
