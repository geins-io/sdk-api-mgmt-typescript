 ...
 * 
 * @export
 * @interface APIOrderTransactionData
 */
export interface APIOrderTransactionData {
    /**
     * 
     * @type {number}
     * @memberof APIOrderTransactionData
     */
    orderId?: number;
    /**
     * 
...
/**
 * Check if a given object implements the APIOrderTransactionData interface.
 */
export function instanceOfAPIOrderTransactionData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function APIOrderTransactionDataFromJSON(json: any): APIOrderTransactionData {
    return APIOrderTransactionDataFromJSONTyped(json, false);
}

export function APIOrderTransactionDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): APIOrderTransactionData {
...
export function APIOrderTransactionDataToJSON(value?: APIOrderTransactionData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
