...
export interface OrderGetPublicRequest {
    publicId: string;
    include: string;
    combineProductContainerRows?: boolean;
}
...
export class OrderApi extends runtime.BaseAPI {
     ...
     * Get an instance of a order
     */
    async orderGetPublicRaw(requestParameters: OrderGetPublicRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderModelsOrder>> {
        if (requestParameters.publicId === null || requestParameters.publicId === undefined) {
            throw new runtime.RequiredError('publicId','Required parameter requestParameters.publicId was null or undefined when calling orderGetPublic.');
        }

        if (requestParameters.include === null || requestParameters.include === undefined) {
            throw new runtime.RequiredError('include','Required parameter requestParameters.include was null or undefined when calling orderGetPublic.');
        }
     ...
     * Get an instance of a order
     */
    async orderGetPublic(requestParameters: OrderGetPublicRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrderModelsOrder> {
        const response = await this.orderGetPublicRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     * Set Payment Detail as paid
     */
    async setPaymentAsPaidRaw(requestParameters: SetPaymentAsPaidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * Set Payment Detail as paid
     */
    async setPaymentAsPaid(requestParameters: SetPaymentAsPaidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
