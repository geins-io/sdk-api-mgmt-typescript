 ...
 * @export
 * @interface EnvelopeInt
 */
export interface EnvelopeInt {
    /**
     * A status message for the action taken.
     * @type {string}
     * @memberof EnvelopeInt
     */
    message?: string;
    /**
...
/**
 * Check if a given object implements the EnvelopeInt interface.
 */
export function instanceOfEnvelopeInt(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EnvelopeIntFromJSON(json: any): EnvelopeInt {
    return EnvelopeIntFromJSONTyped(json, false);
}

export function EnvelopeIntFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvelopeInt {
...
export function EnvelopeIntToJSON(value?: EnvelopeInt | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
