 ...
 * @export
 * @interface EnvelopeBrandModelsReadBrand
 */
export interface EnvelopeBrandModelsReadBrand {
    /**
     * A status message for the action taken.
     * @type {string}
     * @memberof EnvelopeBrandModelsReadBrand
     */
    message?: string;
    /**
    ...
    /**
     * 
     * @type {BrandModelsReadBrand}
     * @memberof EnvelopeBrandModelsReadBrand
     */
    resource?: BrandModelsReadBrand;
    /**
     * 
     * @type {PageResult}
     * @memberof EnvelopeBrandModelsReadBrand
...
/**
 * Check if a given object implements the EnvelopeBrandModelsReadBrand interface.
 */
export function instanceOfEnvelopeBrandModelsReadBrand(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EnvelopeBrandModelsReadBrandFromJSON(json: any): EnvelopeBrandModelsReadBrand {
    return EnvelopeBrandModelsReadBrandFromJSONTyped(json, false);
}

export function EnvelopeBrandModelsReadBrandFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvelopeBrandModelsReadBrand {
    ...
    return {
        ...
        'resource': !exists(json, 'Resource') ? undefined : BrandModelsReadBrandFromJSON(json['Resource']),
        'pageResult': !exists(json, 'PageResult') ? undefined : PageResultFromJSON(json['PageResult']),
    };
}

export function EnvelopeBrandModelsReadBrandToJSON(value?: EnvelopeBrandModelsReadBrand | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'Resource': BrandModelsReadBrandToJSON(value.resource),
