 ...
 * A brand.
 * @export
 * @interface BrandModelsReadBrand
 */
export interface BrandModelsReadBrand {
    /**
     * The unique identifier for the brand.
     * @type {number}
     * @memberof BrandModelsReadBrand
     */
    brandId?: number;
    /**
...
/**
 * Check if a given object implements the BrandModelsReadBrand interface.
 */
export function instanceOfBrandModelsReadBrand(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BrandModelsReadBrandFromJSON(json: any): BrandModelsReadBrand {
    return BrandModelsReadBrandFromJSONTyped(json, false);
}

export function BrandModelsReadBrandFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrandModelsReadBrand {
...
export function BrandModelsReadBrandToJSON(value?: BrandModelsReadBrand | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
