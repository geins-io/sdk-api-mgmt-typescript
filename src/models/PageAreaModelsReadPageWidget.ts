...
export interface PageAreaModelsReadPageWidget {
    ...
    type?: string;
    /**
     * Decides if this {Carismar.MgmtAPI.Features.PageArea.Models.Read.PageWidget} is active or not
     * @type {boolean}
     * @memberof PageAreaModelsReadPageWidget
     */
    active?: boolean;
    ...
    size?: string;
    /**
     * The configuration for this {Carismar.MgmtAPI.Features.PageArea.Models.Read.PageWidget}
     * @type {string}
     * @memberof PageAreaModelsReadPageWidget
     */
