 ...
 * @export
 * @interface CategoryModelsCategoryQuery
 */
export interface CategoryModelsCategoryQuery {
    /**
     * Limits query to categories created after the specified date.
     * @type {Date}
     * @memberof CategoryModelsCategoryQuery
     */
    createdAfter?: Date;
    /**
...
/**
 * Check if a given object implements the CategoryModelsCategoryQuery interface.
 */
export function instanceOfCategoryModelsCategoryQuery(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CategoryModelsCategoryQueryFromJSON(json: any): CategoryModelsCategoryQuery {
    return CategoryModelsCategoryQueryFromJSONTyped(json, false);
}

export function CategoryModelsCategoryQueryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoryModelsCategoryQuery {
...
export function CategoryModelsCategoryQueryToJSON(value?: CategoryModelsCategoryQuery | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
