...
export interface DeleteProductByIdRequest {
    productId: string;
    productIdType?: DeleteProductByIdProductIdTypeEnum;
}
...
export interface UnlinkRelatedProductsByRelationIdRequest {
    productId: string;
    relationTypeId: number;
    relatedProducts: Array<ProductModelsWriteRelatedProduct>;
    productIdType?: UnlinkRelatedProductsByRelationIdProductIdTypeEnum;
}
...
export class ProductApi extends runtime.BaseAPI {
     ...
     */
    async deleteProductByIdRaw(requestParameters: DeleteProductByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Envelope>> {
        if (requestParameters.productId === null || requestParameters.productId === undefined) {
     ...
     * Delete a specific product
     */
    async deleteProductById(requestParameters: DeleteProductByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Envelope> {
    ...
    /**
     * The {Carismar.MgmtAPI.Features.Product.Models.ProductQuery.BatchId} property is mandatory when fetching a page other than the first page.  If no BatchId is provided for the first page, a new batch is created and the BatchId can be found in the {Carismar.MgmtAPI.Infrastructure.Validation.Envelope`1.PageResult} field.
     ...
     */
    async unlinkRelatedProductsByRelationIdRaw(requestParameters: UnlinkRelatedProductsByRelationIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProductModelsRelatedProductEnvelope>> {
        if (requestParameters.productId === null || requestParameters.productId === undefined) {
            throw new runtime.RequiredError('productId','Required parameter requestParameters.productId was null or undefined when calling unlinkRelatedProductsByRelationId.');
        }

        if (requestParameters.relationTypeId === null || requestParameters.relationTypeId === undefined) {
            throw new runtime.RequiredError('relationTypeId','Required parameter requestParameters.relationTypeId was null or undefined when calling unlinkRelatedProductsByRelationId.');
        }

        if (requestParameters.relatedProducts === null || requestParameters.relatedProducts === undefined) {
            throw new runtime.RequiredError('relatedProducts','Required parameter requestParameters.relatedProducts was null or undefined when calling unlinkRelatedProductsByRelationId.');
        }
     ...
     * Remove related products from a product using a fixed relation type
     */
    async unlinkRelatedProductsByRelationId(requestParameters: UnlinkRelatedProductsByRelationIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProductModelsRelatedProductEnvelope> {
        const response = await this.unlinkRelatedProductsByRelationIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const DeleteProductByIdProductIdTypeEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2,
    NUMBER_3: 3
} as const;
export type DeleteProductByIdProductIdTypeEnum = typeof DeleteProductByIdProductIdTypeEnum[keyof typeof DeleteProductByIdProductIdTypeEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const UnlinkRelatedProductsByRelationIdProductIdTypeEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1,
    NUMBER_2: 2,
    NUMBER_3: 3
} as const;
export type UnlinkRelatedProductsByRelationIdProductIdTypeEnum = typeof UnlinkRelatedProductsByRelationIdProductIdTypeEnum[keyof typeof UnlinkRelatedProductsByRelationIdProductIdTypeEnum];
/**
 * @export
 */
