 ...
 * A product supplier.
 * @export
 * @interface SupplierModelsWriteSupplier
 */
export interface SupplierModelsWriteSupplier {
    /**
     * The name of the supplier.
     * @type {string}
     * @memberof SupplierModelsWriteSupplier
     */
    name?: string;
    /**
...
/**
 * Check if a given object implements the SupplierModelsWriteSupplier interface.
 */
export function instanceOfSupplierModelsWriteSupplier(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SupplierModelsWriteSupplierFromJSON(json: any): SupplierModelsWriteSupplier {
    return SupplierModelsWriteSupplierFromJSONTyped(json, false);
}

export function SupplierModelsWriteSupplierFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupplierModelsWriteSupplier {
...
export function SupplierModelsWriteSupplierToJSON(value?: SupplierModelsWriteSupplier | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
