 ...
 * 
 * @export
 * @interface OrderProcessedCapture
 */
export interface OrderProcessedCapture {
    /**
     * 
     * @type {string}
     * @memberof OrderProcessedCapture
     */
    captureId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the OrderProcessedCapture interface.
 */
export function instanceOfOrderProcessedCapture(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OrderProcessedCaptureFromJSON(json: any): OrderProcessedCapture {
    return OrderProcessedCaptureFromJSONTyped(json, false);
}

export function OrderProcessedCaptureFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderProcessedCapture {
...
export function OrderProcessedCaptureToJSON(value?: OrderProcessedCapture | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
