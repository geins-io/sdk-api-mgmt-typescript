 ...
 * A brand.
 * @export
 * @interface BrandModelsWriteBrand
 */
export interface BrandModelsWriteBrand {
    /**
     * The name of the brand.
     * @type {string}
     * @memberof BrandModelsWriteBrand
     */
    name?: string;
    /**
...
/**
 * Check if a given object implements the BrandModelsWriteBrand interface.
 */
export function instanceOfBrandModelsWriteBrand(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BrandModelsWriteBrandFromJSON(json: any): BrandModelsWriteBrand {
    return BrandModelsWriteBrandFromJSONTyped(json, false);
}

export function BrandModelsWriteBrandFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrandModelsWriteBrand {
...
export function BrandModelsWriteBrandToJSON(value?: BrandModelsWriteBrand | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
